...
final class DriverTeamSeeder extends Seeder
{
    ...
    {
        /** @var array<array{team_name: string, given_name: string, family_name: string, driver_sheet_id: string|int|null}> $combinations */
        ...
        foreach ($combinations as $combination) {
            ...
            $team = Team::where('short_name', $combination['team_name'])->first();
